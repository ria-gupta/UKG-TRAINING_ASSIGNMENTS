...
public class SerDeserialization {
	public static void main(String[] args) {
		Employee emp = new Employee("Rajesh", "20", new Address(2, "Pari Chowk", "Noida"), 30000);
		try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(new File("serial.ser")))) {
		...
		try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File("serial.ser")))) {
